...
void GUIScrollbar::_bind_methods() {
	...
	OV_BIND_METHOD(
		GUIScrollbar::set_range_limits,
		{ "new_range_limit_min", "new_range_limit_max", "signal" }, DEFVAL(true)
	);
	OV_BIND_METHOD(
		GUIScrollbar::set_limits, { "new_min_value", "new_max_value", "signal" }, DEFVAL(true)
	);
