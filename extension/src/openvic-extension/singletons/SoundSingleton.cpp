...
void SoundSingleton::_bind_methods() {
	...
	ADD_PROPERTY(
		PropertyInfo(Variant::ARRAY, "song_list", PROPERTY_HINT_ARRAY_TYPE, "AudioStreamMP3"),
		"", "get_song_list"
	);
	...
	ADD_PROPERTY(
		PropertyInfo(Variant::ARRAY, "sound_list", PROPERTY_HINT_ARRAY_TYPE, "AudioStreamWAV"),
		"", "get_sound_list"
	);
